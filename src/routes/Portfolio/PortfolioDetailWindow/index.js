...
import StockDetailWindow from './StockDetailWindow/index.js';
import NoStocksWindow from './NostocksWindows/index'
import {getPortfolio} from '../portfolio.routes'
import './style.css'
    ...
    return (
        <div className="portfolioDetailWindow_main">
            <div className="portfolio_welcomeNote">
                ...
                <span className="portfolio-funds">Funds : {parseFloat(localStorage.getItem("funds")||'0').toFixed(2)}</span>
            </div>
